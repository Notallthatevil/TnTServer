...
macro(enable_clang_tidy)
   find_program(CLANGTIDY clang-tidy HINTS "C:/Projects/llvm-project/build/Release/bin")
   if(CLANGTIDY)

      # clang-tidy only works with clang when PCH is enabled
      if((NOT CMAKE_CXX_COMPILER_ID MATCHES ".*Clang" OR (NOT CMAKE_C_COMPILER_ID MATCHES ".*Clang" )) AND ${ProjectOptions_ENABLE_PCH})
         message(WARNING "clang-tidy cannot be enabled with non-clang compiler and PCH, clang-tidy fails to handle gcc's PCH file. Disabling PCH...")
